...
class Employee:
    ...
    def display(self):
        print("ID: {}, Name: {}, Age: {}, Position: {}, Salary: {}, Department: {}".format(
            self.emp_id, self.name, self.age, self.position, self.salary, self.department))
...
def save_employees(employees, filename):
    ...
    print("Employee records saved to", filename)
...
def load_employees(filename):
    try:
        ...
        print("Employee records loaded from", filename)
        return employees
